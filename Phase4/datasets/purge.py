...
if(len(sys.argv)>1):
	...
	fileARFF		=raw_input("Name of dataset file: ")

csvfiles = glb.glob("*.csv");

for dataCSV in csvfiles:
    
    purgedARFF	=open(dataCSV[:-4] +'-' +  fileARFF,"w")
    ...
    print("result file: " + fileARFF + dataCSV[:-4] + ".arff")
    print("Done")